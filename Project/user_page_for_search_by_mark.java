...
public class user_page_for_search_by_mark extends JFrame {
	static user_page_for_search_by_mark f1;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					f1 = new user_page_for_search_by_mark("",0,"",0,"","");
					f1.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
	 ...
	 * Create the frame.
	 */
	public user_page_for_search_by_mark(String t,int m,String f,int ts,String a,String i) {
