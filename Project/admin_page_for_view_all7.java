...
public class admin_page_for_view_all7 extends JFrame {
	static admin_page_for_view_all7 f1;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					f1 = new admin_page_for_view_all7(0,"",0,"",0,"","");
					f1.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
	 ...
	 */
	public admin_page_for_view_all7(int id,String t,int m,String f,int ts,String a,String i) {
