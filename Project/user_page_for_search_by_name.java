...
public class user_page_for_search_by_name extends JFrame {
	static user_page_for_search_by_name f1;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					f1 = new user_page_for_search_by_name("",0,"",0,"","");
					f1.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
	 ...
	 * Create the frame.
	 */
	public user_page_for_search_by_name(String t,int m,String f,int ts,String a,String i) {
		
		setVisible(true);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(0, 0, 1357, 760);
		...
		lblNewLabel_1.setIcon(new ImageIcon("D:\\All About Java Test\\Project\\src\\Main\\photos\\viewallformedicine.gif"));
		lblNewLabel_1.setBounds(0, 0, 367, 198);
		imgp.add(lblNewLabel_1);
		...
		header.setBounds(340, 13, 664, 69);
